...
generated quantities {
  real weighted_prediction;  
  real y_rep[N, Nt-1];             // Posterior predictive samples
  real log_lik[N, Nt-1];           // Log-likelihood values for LOO calculation
...
# Posterior analysis of stacking weights
...
bayesplot::mcmc_areas(as.array(fit), pars = c("w[1]", "w[2]", "w[3]", "w[4]")) +
