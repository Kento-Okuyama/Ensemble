...
stan_model_ens_no_pooling <- stan_model(model_code = "
data {
...
init_values <- list(
  list(w = matrix(rep(1/3, 3 * n_timepoints), nrow = n_timepoints, ncol = 3), sigma = 1),
  list(w = matrix(rep(1/3, 3 * n_timepoints), nrow = n_timepoints, ncol = 3), sigma = 1),
  list(w = matrix(rep(1/3, 3 * n_timepoints), nrow = n_timepoints, ncol = 3), sigma = 1),
  list(w = matrix(rep(1/3, 3 * n_timepoints), nrow = n_timepoints, ncol = 3), sigma = 1)
)
