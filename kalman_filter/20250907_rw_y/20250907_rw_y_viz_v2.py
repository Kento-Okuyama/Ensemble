...
if os.path.exists(RS_KF_MODEL_FILE):
    ...
    # ▼▼▼【変更点8】保存された時間があれば読み込む ▼▼▼
    duration_rs = saved_data.get('duration', 0.0)
else:
    # ▼▼▼【変更点9】RS-KFの学習時間計測はすでに存在するのでそのまま活用 ▼▼▼
