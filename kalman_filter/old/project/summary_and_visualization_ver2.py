...
for param_name, true_val in true_vals_b1_diag.items():
    if param_name in y_order_b1_diag:
        ...
        inverted_y_pos = num_cats - 1 - y_pos
        ax0.axvline(true_val, ymin=(inverted_y_pos + 0.1) / num_cats, ymax=(inverted_y_pos + 0.9) / num_cats, color='black', ls='--', lw=1.5)
...
true_vals_b1_off = {
    'B1_3fac(0, 1)': true_params['B1_3fac'][0, 1], 'B1_3fac(0, 2)': true_params['B1_3fac'][0, 2],
    'B1_3fac(1, 0)': true_params['B1_3fac'][1, 0], 'B1_3fac(1, 2)': true_params['B1_3fac'][1, 2],
    'B1_3fac(2, 0)': true_params['B1_3fac'][2, 0], 'B1_3fac(2, 1)': true_params['B1_3fac'][2, 1],
}
...
for param_name, true_val in true_vals_b1_off.items():
    if param_name in y_order_b1_off_diag:
        ...
        inverted_y_pos = num_cats_off - 1 - y_pos
        ax1.axvline(true_val, ymin=(inverted_y_pos + 0.1) / num_cats_off, ymax=(inverted_y_pos + 0.9) / num_cats_off, color='black', ls='--', lw=1.5)
...
# ★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★
true_q_vals = {
    'Q_3fac_diag(0,)': true_params['Q_3fac_diag'][0],
    'Q_3fac_diag(1,)': true_params['Q_3fac_diag'][1],
    'Q_3fac_diag(2,)': true_params['Q_3fac_diag'][2],
    'Q_1fac_diag(0,)': true_params['Q_1fac_diag'][0]
}
...
for param_name, true_val in true_q_vals.items():
    if param_name in y_order_q_diag:
        ...
        inverted_y_pos = num_cats_q - 1 - y_pos
        ax2.axvline(true_val, ymin=(inverted_y_pos + 0.1) / num_cats_q, ymax=(inverted_y_pos + 0.9) / num_cats_q, color='black', ls='--', lw=1.5)
